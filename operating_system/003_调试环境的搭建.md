...
- Bochs (另一款优秀的虚拟机软件）
    - 专业模拟 <font color=blue>X86</font> 架构的虚拟机
    - <font color=red>开源</font>且高度可移植，<font color=#00d>由C++编写完成</font>
...
# bochs 的配置
- 小贴士
    - 确定bochs的安装路径 ( <font color=blue>which bochs</font> )
    - 安装 vgabios ( <font color=blue>apt-get install vgabios</font> )
    - 确定 vgabios 的安装路径 ( <font color=blue>whereis vgabios</font> )
...
- 启动 bochs 虚拟机
    - 显示方式 ：bochs <font color=blue>-f</font> <font color=red>bochsrc_file</font>
    - 隐式方式 ：bochs
...
```
# 小结
- Bochs 是一款<font color=blue>专业模拟 x86 架构</font>的虚拟机
- 从源码安装 Bochs 可以获得<font color=red>调试功能</font>的支持
- Bochs 的启动<font color=#d0d>配置文件</font>是正确运行关键
- Bochs 支持断点调试，<font color=#00d>其调试命令与GDB类似</font>
